...
class SppagebuilderAddonFeature extends SppagebuilderAddons {
    ...
    public function render() {
        ...
        $stellaricon_name = (isset($this->addon->settings->stellaricon_name) && $this->addon->settings->stellaricon_name) ? $this->addon->settings->stellaricon_name : '';
        ...
        if ($feature_type == 'icon') {
            if ($icon_name || $stellaricon_name) {
                ...
                if ($stellaricon_name) {
                    $media .= '<i class="stellar-icon ' . $stellaricon_name . '"></i>';
                } else {
    ...
    public static function getTemplate() {
		...
		<#
			...
			if(data.feature_type == "icon") {
				if(data.icon_name || data.stellaricon_name){
					media += \'<div class="sppb-icon">\';
						if( (data.title_url && data.url_appear == "icon") || (data.title_url && data.url_appear == "both" ) ){
							media += \'<a href="\'+data.title_url+\'">\';
						}
						media += \'<span class="sppb-icon-container">\';
                                                    if (data.stellaricon_name) {
                                                        media += \'<i class="stellar-icon \' + data.stellaricon_name + \'"></i>\';
                                                    } else {
