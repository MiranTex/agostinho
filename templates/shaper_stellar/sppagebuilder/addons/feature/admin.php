...
require_once dirname(dirname(__DIR__)) . '/fields/stellaricon.php';
        ...
        array(
            ...
            'attr' => array(
                'general' => array(
                    ...
                    'stellaricon_name' => array(// New Icon
                        'type' => 'select',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_STELLAR_ICON_NAME'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_STELLAR_ICON_NAME_DESC'),
                        'values' => $stellariconslist,
                        'std' => ''
                    ),
                    'icon_name' => array(
                        'type' => 'icon',
